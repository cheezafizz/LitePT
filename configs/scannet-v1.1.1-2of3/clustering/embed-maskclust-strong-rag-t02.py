...
# Identical to that config EXCEPT rag_merge_thresh=0.2 (lower thresh -> more aggressive merge:
...
cluster = dict(
    ...
    rag_merge_thresh=0.2,            # merge adjacent same-class clusters when hist intersection >= 0.2
