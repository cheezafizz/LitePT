...
# Identical to that config EXCEPT rag_merge_thresh=0.4 (lower thresh -> more aggressive merge:
...
cluster = dict(
    ...
    rag_merge_thresh=0.4,            # merge adjacent same-class clusters when hist intersection >= 0.4
