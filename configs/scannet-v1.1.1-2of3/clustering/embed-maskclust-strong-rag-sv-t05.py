# AUTO-GENERATED rag_merge_thresh sweep variant of clustering/embed-maskclust-strong-rag-sv.py.
# Identical to that config EXCEPT rag_merge_thresh=0.5 (shared-view conflict metric:
# LOWER thresh -> stricter -> fewer, larger merges). See embed-maskclust-strong-rag-sv.py
