...
# rag_sim_metric="shared_view_dominant" instead of the legacy global histogram intersection. The new measure is
# the per-view DOMINANT-mask conflict ratio: the fraction of shared views in which the two
# clusters' most-common (modal) 2D mask differs.
