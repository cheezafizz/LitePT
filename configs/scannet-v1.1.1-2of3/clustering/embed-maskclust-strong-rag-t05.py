...
# Identical to that config EXCEPT rag_merge_thresh=0.5 (lower thresh -> more aggressive merge:
# fewer, larger instances; 0.5 == the base config's default). See embed-maskclust-strong-rag.py
