...
# Identical to that config EXCEPT rag_merge_thresh=0.2 (shared-view conflict metric:
...
cluster = dict(
    ...
    rag_merge_thresh=0.2,            # MAX different-mask ratio that still merges (lower = stricter = fewer merges)
