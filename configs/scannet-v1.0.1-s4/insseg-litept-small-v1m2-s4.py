...
save_path = "exp/scannet/insseg-litept-small-v1m2-s4"
...
epoch = 1600
eval_epoch = 200
eval_step_interval = 5000  # log val APs every N optimization steps; ~193 evals at ~192_800 total steps
...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            # Scenes here are ~2-3 m tabletop/industrial, objects 14-40 cm sitting
            # 6-18 cm apart. The room-scale ScanNet defaults [[0.2,0.4],[0.8,1.6]]
            # displaced objects by a median ~0.3 m (2-5x their spacing), merging
            # neighbors. Scaled down to ~3-6 cm warp to preserve instance separability.
